...
* GET_PORT_STATUS を送ると、8バイトのデータが返ってくる。
  * 普通は先頭1バイトがプリンタの状態なのだが、テープ幅がXバイト目に入っているっぽい。

* SPC10-APIのマニュアルにテープ幅の定義が書いてあった。
...
* 基本的にはESP/Pっぽいのだが、基本的に独自仕様の模様
* PCからの印刷の場合、基本的にラスタで送られてくることしか想定していないのだと思われる
  * SPC10に本体内蔵のフォントを使って印刷する機能がないことからの想像
...
```
1b7b074302020101497d
1b7b044405497d
1b7b0347477d
1b7b074ca9010000f67d
1b7b05540e00627d
...(以下印刷データ)
...
* ちなみにSPC10で指定できる印刷長は最大で500mmまでなので、0x1baeが最大値となる
