...
* tepraprintコマンド単体で画像ファイル(png, jpgなど)を直接テプラに流し込めます
...
1b7b074ca9010000f67d (ラベル1枚目ドキュメント印刷長）
...
1b7b074ca9010000f67d (ラベル2枚目ドキュメント印刷長）
1b7b05540e00627d (印刷開始オフセット)
...(以下印刷データ)
1b2e000a0a019000000000000000000000000000000000000000
1b2e000a0a019000000000000000000000000000000000000000
...
| 1b7b0743 02020101 49 7d | ラベルごとにカットする，1枚目ラベルでハーフカットする |
| 1b7b0743 03010101 49 7d | ラベルごとにカットする                                |
| 1b7b0743 03000101 48 7d | JOB毎にカットする，ラベルごとにハーフカットしない     |
| 1b7b0743 02000101 47 7d | JOB毎にカットする，ラベルごとにハーフカットする       |
<!--
...
* WIDTHは印刷する幅(Litte endgienで2バイト)を示す。テプラの場合はテープ幅に応じた値が入る
  * 1mmあたり0xC(12)が入り、例えば12mmのテープの場合は0x90(144)となる。
